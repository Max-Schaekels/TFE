...
class CustomUserRegisterForm(UserCreationForm):
    ...
    def __init__(self, *args : Any, **kwargs : Any) -> None:
        ...
        self.fields['username'].widget.attrs["class"] = 'form-control' #modification de l'attribut class du widget du field username
        ...
        self.fields['email'].widget.attrs["class"] = 'form-control' #modification de l'attribut class du widget du field email
        ...
        self.fields['password1'].widget.attrs["class"] = 'form-control' #modification de l'attribut class du widget du field password1
        ...
        self.fields['password2'].widget.attrs["class"] = 'form-control' #modification de l'attribut class du widget du field password2
